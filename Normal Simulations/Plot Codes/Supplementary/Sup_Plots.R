...
for (i in seq_along(batches_power)) {
  output_file <- paste(dir, "Plots/Supplementary", paste0(paste("Power_vareff", var_eff, "pDM", p_DM, sep = '_'), ".png"), sep = '/')
...
for (i in seq_along(batches_mcc)) {
  output_file <- paste(dir, "Plots/Supplementary", paste0(paste("MCC_vareff", var_eff, "pDM", p_DM, sep = '_'), ".png"), sep = '/')
  png(output_file, units = 'in', width = 20, height = 20, res = 300)
...
for (i in seq_along(batches_f1)) {
  output_file <- paste(dir, "Plots/Supplementary", paste0(paste("F1_vareff", var_eff, "pDM", p_DM, sep = '_'), ".png"), sep = '/')
  png(output_file, units = 'in', width = 20, height = 20, res = 300)
...
for (i in seq_along(batches_auc)) {
  output_file <- paste(dir, "Plots/Supplementary", paste0(paste("AUROC_vareff", var_eff, 'pDM', p_DM, sep = '_'), ".png"), sep = '/')
  png(output_file, units = 'in', width = 20, height = 20, res = 300)
